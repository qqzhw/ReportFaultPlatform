...
namespace ReportFault.Web
{
    ...
    public static class WebContentDirectoryFinder
    {
        ...
        {
            var coreAssemblyDirectoryPath = Path.GetDirectoryName(typeof(ReportFaultCoreModule).GetAssembly().Location);
            if (coreAssemblyDirectoryPath == null)
            {
                throw new Exception("Could not find location of ReportFault.Core assembly!");
            }
