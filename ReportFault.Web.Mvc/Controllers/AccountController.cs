...
using ReportFault.Web.Models.Account;
using ReportFault.Authorization.Users;
using ReportFault.Controllers;
using ReportFault.Identity;
using ReportFault.Sessions;
using ReportFault.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNetCore.Identity;

namespace ReportFault.Web.Controllers
{
    public class AccountController : ReportFaultControllerBase
    {
